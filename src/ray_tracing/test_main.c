...
// /*   Updated: 2023/12/16 21:16:06 by helauren         ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
void	init_theo(t_data *data)
{
	...
	}
	{
		...
		data->ambient_lighting->rgb.r = 255;
		data->ambient_lighting->rgb.g = 255;
		data->ambient_lighting->rgb.b = 255;
	}
	{
	...
	}
	{
		...
		data->first->id = SPHERE;
		{
			...
			sphere_data->pos.x = 0;
			sphere_data->pos.y = 0;
			sphere_data->pos.z = 100;
			sphere_data->diameter = 0.5;
			sphere_data->rgb.r = 10;
			sphere_data->rgb.g = 0;
			sphere_data->rgb.b = 255;
		}
