...
/*   Updated: 2024/01/28 01:41:33 by helauren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec3	point_on_line(t_vec3 start, t_vec3 end, t_vec3 len)
{
	t_vec3	vector;
	double	distance;
